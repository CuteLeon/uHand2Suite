...
internal class Program
{
    ...
    [Description(
        ...
        时间参数：参数“durationMs”控制动作执行时间，为可选uint16类型，单位为毫秒，默认值为500，表示500毫秒。
        大拇指角度参数：参数“thumbAngle”控制大拇指伸直与卷曲，为可选uint16类型，范围为900至2000之间的整数，900表示大拇指完全弯曲，2000表示完全伸直，null表示保持当前位置，默认值为null。
        食指角度参数：参数“indexFingerAngle”控制食指伸直与卷曲，为可选uint16类型，范围为900至2000之间的整数，900表示食指完全弯曲，2000表示完全伸直，null表示保持当前位置，默认值为null。
        中指角度参数：参数“middleFingerAngle”控制中指伸直与卷曲，为可选uint16类型，范围为900至2000之间的整数，900表示中指完全弯曲，2000表示完全伸直，null表示保持当前位置，默认值为null。
        无名指角度参数：参数“ringFingerAngle”控制无名指伸直与卷曲，为可选uint16类型，范围为900至2000之间的整数，900表示无名指完全弯曲，2000表示完全伸直，null表示保持当前位置，默认值为null。
        小拇指角度参数：参数“pinkyFingerAngle”控制小拇指伸直与卷曲，为可选uint16类型，范围为900至2000之间的整数，900表示小拇指完全弯曲，2000表示完全伸直，null表示保持当前位置，默认值为null。
